...
| M2 | 4 | Noise and adversarial generator | adversarial-engineer | opus | ready |
| M2 | 5 | Annotator agents, agreement, adjudication | label-architect | opus | ready |
| M3 | 6 | Train the character model and the transformer baselines | ml-trainer | sonnet | blocked |
...
| M4 | 11 | Evaluation, prefilter recall gate, robustness per family | eval-engineer | sonnet | blocked |
